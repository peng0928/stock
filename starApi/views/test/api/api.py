...
async def sse_fs(request: Request, item):
    ...
    url = 'http://78.push2.eastmoney.com/api/qt/stock/trends2/sse?fields1=f1,f2,f3,f4,f5,f6,f7,f8,f9,f10,f11,f12,f13,f17&fields2=f51,f52,f53,f54,f55,f56,f57,f58&mpi=1000&ut=&secid={}&ndays=1&iscr=0&iscca=0&wbp2u=|0|0|0|web'.format(item)
...
async def sse_info(request: Request, item):
    ...
    fields = ','.join(fields)
    url = 'http://16.push2.eastmoney.com/api/qt/stock/sse?fields={}&mpi=1000&invt=2&fltt=1&secid={}&ut=&dect=1&wbp2u=|0|0|0|web'.format(fields, item)
